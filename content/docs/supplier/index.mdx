...
| --- | --- |
| Add a new distributor | [Add a Supplier](/docs/suppliers/add-supplier) |
| See what you owe all suppliers | [Ledger](/docs/suppliers/ledger) |
| Fix a wrong opening balance | [Ledger → Adjust](/docs/suppliers/ledger) |
| Restore a deleted supplier | [Trash](/docs/suppliers/trash) |
| Record stock you received | [Add Purchase](/docs/purchases/add-purchase) |
| Pay a supplier | [Add Supplier Payment](/docs/suppliers/payments) |

<Note>
You can also access **Add Supplier** and **Add Supplier Payment** from the `+` quick-add menu on any screen, without navigating to the Suppliers section.
</Note>